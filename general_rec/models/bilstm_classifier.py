...
class BiLSTMClassifier(Model):
    def __init__(self,
        ...
        super(BiLSTMClassifier, self).__init__(vocab)
    ...
    def forward(self,
        ...
        encoded_sum_text = encoded_text.view(encoded_text.shape[0], 2, -1)
        encoded_sum_text = torch.sum(encoded_sum_text, dim = 1)

        logits = torch.sigmoid(self.classifier_feedforward(encoded_sum_text))
