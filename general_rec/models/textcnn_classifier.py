...
@Model.register("textcnn_classifier")
class TextCNNClassifier(Model):
    def __init__(self,
        ...
        super(TextCNNClassifier, self).__init__(vocab)
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        return {
            "_hamming_loss2": hamming_loss2,
            "_accuracy2": accuracy2,
            "_precision2": precision2,
            "_recall2": recall2,
            "f1score2": f1score2,

            "_hamming_loss3": hamming_loss3,
            "_accuracy3": accuracy3,
            "_precision3": precision3,
            "_recall3": recall3,
            "f1score3": f1score3,
            
            "_hamming_loss5": hamming_loss5,
            "_accuracy5": accuracy5,
            "_precision5": precision5,
            "_recall5": recall5,
            "f1score5": f1score5,
            }
