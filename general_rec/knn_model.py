...
class KNNModel(object):
    ...
    def train(self, dataset):
        ...
        tfidf_features = self.Tfidf_vect.transform(preprocessed_dataset)
        valid_x = tfidf_features
        
        self.knn = KNeighborsClassifier(n_neighbors=5, weights='uniform')
        # self.bagging = BaggingClassifier(self.knn, max_samples=0.6, max_features=0.7, verbose=1, oob_score=True)
        self.model = OneVsRestClassifier(self.knn)
